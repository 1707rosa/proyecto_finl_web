...
<nav class="navbar navbar-expand-lg navbar-dark bg-black mb-2 p-3">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?= $base_url ?>/Views/dashboard.php">SIR - Reporte de Incidencias</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link active" href="<?= $base_url ?>/Views/dashboard.php">Inicio</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= $base_url ?>/Views/Mapa/mapa.php">Mapa de Incidencias</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= $base_url ?>/?vista=Acerca">Acerca</a>
                </li>
